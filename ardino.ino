...
#define WIFISSID "Redmi10Prime" // Enter WifiSSID here
#define PASSWORD "hahaha12345" // Enter password here
#define TOKEN "BBFF-nZMgPVlsIZnan3L2cVPGkS3jJ1lkZg" // Ubidots' TOKEN
